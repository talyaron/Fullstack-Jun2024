...
function rng() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, x, message, messageElement, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    return [4 /*yield*/, fetch('http://localhost:3000/api/rng')];
                case 1:
                    response = _a.sent();
                    console.log(response);
                    return [4 /*yield*/, response.json()];
...
function countUp() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, message, messageElement, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    ...
                    console.time('fetching bye');
                    y++;
                    return [4 /*yield*/, fetch('http://localhost:3000/api/countUp')];
                case 1:
                    response = _a.sent();
                    console.log(response);
                    return [4 /*yield*/, response.json()];
                case 2:
                    ...
                    if (!message)
                        throw new Error('No message found');
                    messageElement = document.querySelector("#counter");
                    if (!messageElement)
                        throw new Error('No message element found');
