...
function getHello() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 3,, 4]); //we will call the server


          console.time('fetching hello');
          return [4
          /*yield*/
          , fetch('http://localhost:3000/api/get-hello')];
        ...
        case 2:
          ...
          messageElement = document.querySelector("#yosk");
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , fetch('http://localhost:3000/api/get-randomNumber')];
        ...
        case 2:
          data = _a.sent();
          console.log(data);
          x = document.getElementById("show_the_number");
