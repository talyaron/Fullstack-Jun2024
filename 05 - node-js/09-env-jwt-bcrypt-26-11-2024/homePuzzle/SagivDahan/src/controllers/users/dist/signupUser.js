...
function signupUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, userName, email, password, phoneNumber, user, id, hashedPassword, newUser, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    error_1 = _b.sent();
                    console.error("Error occurred:", error_1.message || error_1);
                    res.status(500).json({ error: error_1.message || "An error occurred while adding the user" });
                    return [3 /*break*/, 5];
