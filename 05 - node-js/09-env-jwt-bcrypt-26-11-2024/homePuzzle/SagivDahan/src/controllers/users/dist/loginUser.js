        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    token = jwt_simple_1["default"].encode(user, secret);
                    console.log("encode token:", token);
                    //send user cookie to client
                    res.cookie('user', user, { httpOnly: true, maxAge: 1000 * 60 * 60 * 24 * 7 });
                    res.json(user);
                    return [3 /*break*/, 4];
                case 3: return [2 /*return*/, res.status(400).json({ message: 'You are not registered, please sign up.' })];
                case 4: return [3 /*break*/, 6];
                case 5:
                    error_1 = _b.sent();
                    console.error("Error in /api/login:", error_1);
