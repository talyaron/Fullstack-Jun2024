...
var addUserCont_1 = require("./addUserCont");
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, user, match, token, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    user = _b.sent();
                    if (!user) {
                        return [2 /*return*/, res.status(400).send({ error: "Invalid email or password1" })];
                    }
                    if (!user.password)
                ...
                case 2:
                    ...
                    token = jwt_simple_1["default"].encode({ id: user._id, role: "user" }, addUserCont_1.secret);
