...
function register(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, firstName, lastName, email, password, phone, saltRounds, hashpass, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email, password, user, credentials, token, error_3;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 2:
                    credentials = _b.sent();
                    if (!credentials) {
                        return [2 /*return*/, res.status(400).send({ error: "Invalid password" })];
                    }
