...
function registerClient(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, phoneNumber, password, hashedPassword, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, clientModel_1.ClientModel.create({ name: name, phoneNumber: phoneNumber, password: hashedPassword })];
                case 2:
                    _b.sent();
                    return [2 /*return*/, res.json({ message: "Account created sucssussfully" })];
                case 3:
                    error_1 = _b.sent();
