...
function getMyProducts(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, decoded, _products, products, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log(user);
                    decoded = jwt_simple_1["default"].decode(user, setClients_1.secret);
                    console.log(decoded);
                    return [4 /*yield*/, purchaseModel_1.PurchaseModel.find({ clientId: decoded.id }).populate('productId')];
                case 1:
                    _products = _a.sent();
                    products = _products.map(function (product) { return product.productId; });
                    res.json({ message: "Get all products", useId: user, products: products });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.log(error_1);
