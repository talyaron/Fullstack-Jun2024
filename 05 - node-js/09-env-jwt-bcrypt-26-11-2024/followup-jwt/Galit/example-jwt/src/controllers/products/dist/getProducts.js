...
function getMyProducts(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var token, decoded, userId, products, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    decoded = jwt_simple_1["default"].decode(token, setClients_1.secret);
                    userId = decoded.id;
                    return [4 /*yield*/, productModel_1["default"].find({ userId: userId })];
                case 1:
                    products = _a.sent();
                    res.json({ message: "Get all products", userId: userId, products: products });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.log(error_1);
