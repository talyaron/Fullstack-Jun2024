...
function renderProduct(product) {
    return "\n    <div class=\"product-card\">\n        <img src=\"https://media.istockphoto.com/id/539071535/photo/bowl-of-dog-food.jpg?s=612x612&w=0&k=20&c=48jSoNa5Vod-1inwbhpSQWKv5eEIhnWr8YAfhKI823M=\" alt=\"" + product.name + "\" class=\"product-card__image\">\n        <div class=\"product-card__info\">\n            <span class=\"product-card__category\">" + product.category + "</span>\n            <h2 class=\"product-card__title\">" + product.name + "</h2>\n            <p class=\"product-card__description\">" + product.description + "</p>\n            <div class=\"product-card__footer\">\n                <span class=\"product-card__price\">$" + product.price + "</span>\n                <div class=\"product-card__stock\">\n                    <span class=\"product-card__stock-dot\"></span>\n                    " + (product.inStock ? "In Stock" : "Out of Stock") + "\n                </div>\n            </div>\n            <button class=\"product-card__button\" onclick=\"handleAddToCart('" + product._id + "')\">Add to Cart</button>\n        </div>\n    </div>\n    ";
}
function handleGetProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, products, productsContainer, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    productsContainer.innerHTML = products
                        .map(function (product) { return renderProduct(product); })
                        .join("");
                    _a.label = 3;
...
function handleGetMyProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, purchases, productsContainer, products, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    if (!Array.isArray(purchases))
                        throw new Error("Products is not an array");
                    products = purchases.map(function (purchase) { return purchase.productId; });
                    if (products.length === 0) {
                        productsContainer.innerHTML = "<p>No products found</p>";
                    }
                    console.log(data);
