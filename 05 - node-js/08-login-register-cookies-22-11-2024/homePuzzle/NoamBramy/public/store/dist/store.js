...
function handleGetMyProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var response, products, productsContainer, message, productsContainer, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, fetch('/api/products/my-products')];
                case 1:
                    response = _a.sent();
                    if (!response.ok) return [3 /*break*/, 3];
                    return [4 /*yield*/, response.json()];
                ...
                case 6:
                    error_2 = _a.sent();
                    console.error('An error occurred during getting my products:', error_2);
                    return [3 /*break*/, 7];
...
function handleAddToCart(id) {
    try {
        ...
        var response = fetch('/api/purchase/add-to-cart', {
            method: 'POST',
            headers: {
