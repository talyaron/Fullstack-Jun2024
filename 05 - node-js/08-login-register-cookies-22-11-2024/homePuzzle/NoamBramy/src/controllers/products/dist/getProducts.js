...
function getMyProducts(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, purchases, products, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!user) {
                        return [2 /*return*/, res.status(401).json({ message: "Unauthorized: User not logged in" })];
                    }
                ...
                case 1:
                    ...
                    res.status(200).json({ message: "User's products retrieved successfully", products: products });
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
