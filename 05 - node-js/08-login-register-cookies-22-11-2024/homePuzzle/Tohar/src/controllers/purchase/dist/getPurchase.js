...
exports.getUserPurchases = exports.getUserCartProducts = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, purchaseModel_1.PurchaseModel.find({
                            userId: user.id,
                            status: "in-cart"
                        }).populate("productId")];
                case 1:
...
exports.getUserCartProducts = getUserCartProducts;
;
