...
exports.registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, password, email, phone, user, newUser, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, name = _a.name, password = _a.password, email = _a.email, phone = _a.phone;
            ...
            case 3:
                err_1 = _b.sent();
                console.error("Error in registerUser: ", err_1);
