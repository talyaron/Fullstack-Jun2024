...
function editTitlePost(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var title, post, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    title = req.body.title;
                    return [4 /*yield*/, postModel_1.PostModel.findByIdAndUpdate(req.params.id, { title: title }, { "new": true })];
                case 1:
                    post = _a.sent();
                    if (post) {
                        console.log('Updated title post:', post);
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error("Error in editTitle: ", err_1);
                    res.status(500).json({ error: "Internal Server Error" });
                    return [3 /*break*/, 3];
