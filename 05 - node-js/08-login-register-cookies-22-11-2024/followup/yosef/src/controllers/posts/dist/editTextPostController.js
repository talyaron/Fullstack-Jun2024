...
function editTextPost(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var text, post, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    text = req.body.text;
                    return [4 /*yield*/, postModel_1.PostModel.findByIdAndUpdate(req.params.id, { text: text }, { "new": true })];
                case 1:
                    post = _a.sent();
                    if (post) {
                        console.log('Updated text post:', post);
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error in editTextPost:', error_1);
                    res.status(500).json({ error: 'Internal server error' });
                    return [3 /*break*/, 3];
