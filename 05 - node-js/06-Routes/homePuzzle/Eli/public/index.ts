...
async function checkKey() {
  try {
    if (key.length > 1) {
      const response = await fetch(`http://localhost:3000/api/users/check-key`, {
        method: "POST",
        headers: {
...
async function logOut() {
  try {
    const response = await fetch(`http://localhost:3000/api/users/log-out`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
async function updatePostServer(id, title, desc, img) {
  try {
    ...
    const response = await fetch(`http://localhost:3000/api/post/update-post`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
async function removePost(postId) {
  try {
    ...
    const response = await fetch(`http://localhost:3000/api/post/remove-post`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
