        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _id = req.body._id;
                    if (!_id) {
                        return [2 /*return*/, res.status(400).json({ message: "Client ID is required" })];
                    }
                    return [4 /*yield*/, clientModel_1.ClientModel.findByIdAndDelete(_id)];
                case 1:
