...
function addUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, name, email, phone, imageUrl, yearOfBirth, result, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name = _a.name, email = _a.email, phone = _a.phone, imageUrl = _a.imageUrl, yearOfBirth = _a.yearOfBirth;
