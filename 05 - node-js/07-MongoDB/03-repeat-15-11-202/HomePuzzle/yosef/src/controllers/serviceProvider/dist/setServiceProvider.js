...
function addServiceProvider(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, serviceProviderName, phone, email, price, averageRating, newServiceProvider, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, serviceProviderName = _a.serviceProviderName, phone = _a.phone, email = _a.email, price = _a.price, averageRating = _a.averageRating;
