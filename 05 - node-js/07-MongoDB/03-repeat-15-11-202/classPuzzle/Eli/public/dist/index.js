...
function submitSchedule(event) {
    return __awaiter(this, void 0, void 0, function () {
        var form, providersElement, formData, name, date, response, data, allProvider, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    providersElement = document.getElementById("providers-container");
                    if (!providersElement) {
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/all/check-schedule", {
                            method: "POST",
...
function renderProvider(allProvider, providersElement) {
    allProvider.forEach(function (provider) {
        ...
        var formattedDate = new Date(provider.workDate).toLocaleDateString('en-GB');
