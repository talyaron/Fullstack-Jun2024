...
function checkSchedule(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var date, allProvider, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    date = req.body.date;
                    return [4 /*yield*/, serviceProviderModel_1.ServiceProviderModel.find({ date: date })];
                case 1:
                    allProvider = _a.sent();
                    if (allProvider.length < 0)
                        res.err({ error: "no providers!" });
                    console.log(allProvider);
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    res.json({ error: "a problem has accured" });
                    return [3 /*break*/, 3];
