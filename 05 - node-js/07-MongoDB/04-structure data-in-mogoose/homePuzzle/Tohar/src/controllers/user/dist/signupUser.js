        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    userModel_1.users.push({ userName: userName, email: email, password: password, phoneNumber: phoneNumber, id: id, isProvider: false });
                    newUser = new userModel_1.userModel({ userName: userName, email: email, password: password, phoneNumber: phoneNumber, id: id, isProvider: false });
