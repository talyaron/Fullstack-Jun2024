        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    console.log(result);
                    if (!result) {
                        return [2 /*return*/, res.status(400).send({ error: "Couldn't create new sP!" })];
                    }
                    return [2 /*return*/, res.status(201).send({ message: "sP was created successfully!" })];
                case 2:
                    error_1 = _b.sent();
                    console.error("error");
