...
exports.getSPByEmail = exports.getUserById = void 0;
...
function getSPByEmail(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var email, sP, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ...
                    return [4 /*yield*/, serviceProviderModel_1.serviceProviderModel.findOne({ email: email })];
                case 1:
                    sP = _a.sent();
                    if (!sP) {
                        console.log('sP is not exist'); // Log the message
                        return [2 /*return*/, res.status(400).json({ message: 'sP is not exist' })];
                    }
...
exports.getSPByEmail = getSPByEmail;
