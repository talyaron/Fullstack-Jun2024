...
function addServiceProvider(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var name, newServiceProvider, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    newServiceProvider = new serviceProviderModel_1.ServiceProviderModel({ name: name });
                ...
                case 2:
                    error_1 = _a.sent();
                    res.status(500).json({ message: "Error adding service provider", error: error_1.message });
                    return [3 /*break*/, 3];
