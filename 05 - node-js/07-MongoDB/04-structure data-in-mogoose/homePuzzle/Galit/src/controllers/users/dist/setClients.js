        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    id = req.params.id;
                    return [4 /*yield*/, ClientModel_1.ClientModel.findById(id)];
                case 1:
                    client = _a.sent();
                    if (!client) {
...
function editClient(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, id, firstName, lastName, email, phone, yearOfBirth, updatedFields, updatedClient, error_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = req.body, id = _a.id, firstName = _a.firstName, lastName = _a.lastName, email = _a.email, phone = _a.phone, yearOfBirth = _a.yearOfBirth;
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    ...
                    if (yearOfBirth !== undefined)
                        updatedFields.yearOfBirth = yearOfBirth;
                    return [4 /*yield*/, ClientModel_1.ClientModel.findByIdAndUpdate(id, updatedFields, { "new": true })];
                case 2:
