...
function createPost(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, caption, imageURL, id, newPost, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, caption = _a.caption, imageURL = _a.imageURL;
                    if (!caption || !imageURL) {
                    ...
                    newPost = new postModel_1.PostModel({ caption: caption, imageURL: imageURL, id: id });
                ...
                case 2:
                    error_1 = _b.sent();
                    console.error("Error in /api/add-post:", error_1);
