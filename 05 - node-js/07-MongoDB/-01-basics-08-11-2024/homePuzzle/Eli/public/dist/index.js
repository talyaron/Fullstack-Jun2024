        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/users/check-key", {
                            method: "POST",
                            headers: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/add-post", {
                            method: "POST",
                            body: formData
                        })];
                case 1:
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("http://localhost:3000/api/users/log-out", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json"
                            },
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/update-post", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json"
                            },
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/remove-post", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json"
                            },
