...
exports.updatePost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, title, desc, img, foundPost, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 3, , 4]);
                _a = req.body, id = _a.id, title = _a.title, desc = _a.desc, img = _a.img;
                return [4 /*yield*/, postsModel_1.PostModel.findOne({ id: id })];
            case 1:
                foundPost = _b.sent();
                if (!foundPost) {
