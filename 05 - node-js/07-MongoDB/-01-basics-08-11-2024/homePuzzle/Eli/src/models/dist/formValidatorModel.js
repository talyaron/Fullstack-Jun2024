...
var infoValidator = /** @class */ (function () {
    function infoValidator() {
        var _this = this;
        this.isEmailValid = function (email) { return __awaiter(_this, void 0, void 0, function () {
            var emailExist;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (this.regE.test(email) == false)
                            return [2 /*return*/, "invalid email : email needs @ and a .com ending"];
                        if (emailExist)
                            return [2 /*return*/, "invalid email : email already exists!"];
                        return [2 /*return*/, ""];
                }
            });
        }); };
