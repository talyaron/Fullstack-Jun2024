...
function updateImagePost(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, imageUrl, id, updatedPost, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, imageUrl = _a.imageUrl, id = _a.id;
                    if (!imageUrl || !id)
                        throw new Error("Missing title ");
                    return [4 /*yield*/, postModel_1.PostModel.findByIdAndUpdate(id, { imageUrl: imageUrl }, { "new": true } // Returns the updated document
                        )];
                case 1:
                    updatedPost = _b.sent();
                    if (!updatedPost) {
