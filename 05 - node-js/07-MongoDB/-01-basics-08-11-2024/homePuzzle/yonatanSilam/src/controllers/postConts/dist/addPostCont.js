...
function addPost(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, imageUrl, text, title, id, newPost, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, imageUrl = _a.imageUrl, text = _a.text, title = _a.title;
                    if (!imageUrl || !text || !title)
                        throw new Error("Missing imageUrl or text");
                    id = crypto.randomUUID();
                    newPost = new postModel_1.PostModel({ imageUrl: imageUrl, text: text, title: title });
