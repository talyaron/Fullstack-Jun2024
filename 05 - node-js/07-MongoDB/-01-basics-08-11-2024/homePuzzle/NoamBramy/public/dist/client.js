...
function handleSendForm(event) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var target, titleInput, title, textInput, text, imageFile, imageUrl, imageData, uploadResponse, uploadResult, response, errorData, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 6: return [4 /*yield*/, getPosts()];
                case 7:
                    _b.sent();
                    return [3 /*break*/, 9];
                case 8:
