    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/get-user?user=" + userId)];
                case 1:
                    response = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("getPosts", error_1);
                    return [3 /*break*/, 4];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/edit", {
                            method: 'PATCH',
                            headers: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    user = localStorage.getItem("user");
                    return [4 /*yield*/, fetch("http://localhost:3000/api/post/delete", {
                            method: 'DELETE',
                            headers: {
                                'Content-Type': 'application/json'
                            },
