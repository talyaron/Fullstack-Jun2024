...
function Welcome() {
  return React.createElement("main", {
    ...
    to: "/yosefSystem"
  }, "Join Yosef System"), React.createElement("div", {
    ...
    src: logo_light_svg_1["default"],
    alt: "React Router",
    className: "block w-full dark:hidden"
  }), React.createElement("img", {
    src: logo_dark_svg_1["default"],
    alt: "React Router",
  ...
  }, "What's next?"), React.createElement("ul", null, resources.map(function (_a) {
    var href = _a.href,
        text = _a.text,
        icon = _a.icon;
