...
console.log(found);
var spasific_year = books.filter(function (x) { return x.year > 1990; }); /*  04  */
...
console.log(management_system);
var new_array = remove_item(management_system, 123); /*  03 - B  */
// management_system = new_array;
console.log(new_array);
console.log(management_system);
var update_array = update(management_system, 777, 1); /*  03 - C  */
console.log(update_array);
console.log("now");
console.log(management_system);
var founded = found_item(management_system, "Screen"); /*  03  - D  */
console.log(founded);
...
function remove_item(arr, id) {
    var new_arr = arr.filter((function (arr) { return arr.id != id; }));
    return new_arr;
}
function update(arr, id, new_quantity) {
    var new_arr, _a = arr.forEach((function (arr) {
        if (arr.id == id)
...
function found_item(arr, name) {
    var new_array = arr.filter((function (arr) { return arr.name == name; }));
    return new_array;
}
function total(arr) {
    var sum = 0;
