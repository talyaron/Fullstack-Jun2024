...
var Solider = /** @class */ (function (_super) {
    ...
    Solider.prototype.canIMove = function (row, colum) {
        ...
        lastPosition.push({ row: row, colum: colum });
        //black
        if (!this.color) {
            if (board[row + 1][colum + 1] != undefined) {
                ...
                else if (((_a = board[row + 1][colum + 1].piece) === null || _a === void 0 ? void 0 : _a.color) &&
            ...
            if (board[row + 1][colum - 1] != undefined) {
                ...
                else if (((_b = board[row + 1][colum - 1].piece) === null || _b === void 0 ? void 0 : _b.color) &&
                    board[row + 1][colum - 1].occupied) {
                    if (board[row + 2][colum - 2]) {
                        if (!board[row + 2][colum - 2].occupied) {
                            board[row + 2][colum - 2].html.style.backgroundColor = "yellow";
            ...
            if (board[row - 1][colum - 1] != undefined) {
                ...
                else if (!((_c = board[row - 1][colum - 1].piece) === null || _c === void 0 ? void 0 : _c.color) &&
                    board[row - 1][colum - 1].occupied) {
                    if (board[row - 2][colum - 2]) {
                        if (!board[row - 2][colum - 2].occupied) {
                            board[row - 2][colum - 2].html.style.backgroundColor = "yellow";
            ...
            if (board[row - 1][colum + 1] != undefined) {
                ...
                else if (!((_d = board[row - 1][colum + 1].piece) === null || _d === void 0 ? void 0 : _d.color) &&
                    board[row - 1][colum + 1].occupied) {
                    if (board[row - 2][colum + 2]) {
                        if (!board[row - 2][colum + 2].occupied) {
                            board[row - 2][colum + 2].html.style.backgroundColor = "yellow";
...
var Esteeple = new Solider(false, "");
//create the board
var board = [];
function main() {
    var _a;
