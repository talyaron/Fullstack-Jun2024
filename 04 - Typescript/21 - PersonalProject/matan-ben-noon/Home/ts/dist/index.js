...
function createDashboard() {
    ...
    coursesDiv.innerHTML = "<h3>Your Courses</h3><ul>" + registeredCourses.map(function (course) { return "<li>" + course.name + "</li>"; }).join('') + "</ul>";
...
function getCoursesForStudent() {
    return courses.filter(function (course) { return currentUser.courses.includes(course.id); });
}
// === controller ===
