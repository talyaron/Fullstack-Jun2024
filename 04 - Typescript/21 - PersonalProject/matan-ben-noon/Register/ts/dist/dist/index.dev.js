...
function createRegisterForm() {
  ...
  courseSelect.id = 'courses';
  courseSelect.classList.add('register-form__select');
  courseSelect.multiple = true;
...
function handleRegister(event) {
  ...
  var selectedCourses = Array.from(courseSelect.selectedOptions).map(function (option) {
